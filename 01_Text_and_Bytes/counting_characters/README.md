...
- [`length` counts code points ↗](https://masiarek.github.io/perl-learning-library/02_Unicode_Text/length_counts_code_points/index.html) — Perl's `length` gives `len()`'s answer, and its regex engine's `\X` counts graphemes
