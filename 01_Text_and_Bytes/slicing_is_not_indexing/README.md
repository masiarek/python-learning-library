...
- [Past the end, an array gives nil, not an error ↗](https://masiarek.github.io/ruby-learning-library/04_Collections/arrays_and_negative_indexes/index.html) — the Ruby side: `a[10]` on a four-element array is `nil`, `a[5] = 99` pads the gap with `nil`, and a slice is `a[1..2]` (end…
...
- [Two dots include the end, three dots exclude it ↗](https://masiarek.github.io/ruby-learning-library/04_Collections/ranges_two_dots_and_three/index.html) — the Ruby side: `1..5` is five numbers and `1...5` is four; a Range can be endless (`1..`), beginless (`..5`), made of Strings…
