...
**Progress, 2026-09-07.** Pages 1, 3 and 4 have landed. Closed: #1, #2, #5, #6, #12, #15, #19, #20a, #26, #29, #30, #31 — twelve of the forty, in three pages, which is the point of grouping them. Two to go: **string literals** and **the drilling mechanism**.
